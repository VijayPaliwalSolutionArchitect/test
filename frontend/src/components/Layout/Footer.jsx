 ...
 * Features modern design with multiple sections
 */
const Footer = () => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[var(--text-secondary)] text-sm mb-4">
              Building modern web applications with cutting-edge technologies and beautiful design.
            </p>
            {/* Social Links */}
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-[var(--text-secondary)] hover:text-[var(--color-primary)] transition-colors duration-300 hover:scale-110 transform"
            ...
            <ul className="space-y-2">
              {footerLinks.product.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-[var(--text-secondary)] hover:text-[var(--color-primary)] text-sm transition-colors duration-300"
                  >
                    {link.name}
                  </a>
                </li>
        ...
        <div className="pt-8 border-t border-[var(--border-color)]">
          <p className="text-center text-[var(--text-secondary)] text-sm">
            © {currentYear} MEAN Stack App. All rights reserved. Built with ❤️ using React, Vite, and Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
