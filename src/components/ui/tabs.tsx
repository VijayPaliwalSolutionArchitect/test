...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gray-100/80 backdrop-blur-sm p-1 text-gray-600",
      className
    )}
    {...props}
  />
